...
p1 = particle(np.array([200,400]), np.array([5,0]), np.array([0,0]), np.array([0,0]), np.array([0,0]),100,100,5,np.array([0,0]))
p2 = particle(np.array([500,400]), np.array([0,0]), np.array([0,0]), np.array([0,0]), np.array([0,0]),100,100,5,np.array([0,0]))
p3 = particle(np.array([700,500]), np.array([-5,0]), np.array([0,0]), np.array([0,0]), np.array([0,0]),100,100,5,np.array([0,0]))
...
die zuordnung von den partikeln i&j aus combinations muss bekannt sein, damit die partikel, die interagieren, auch geupdatet werden können
      ...
      # for n_particle in particle.list_of_particles:
       ...
       n_particle.position = new_posi
       n_particle.velocity = new_veli
       n_particle.acceleration = new_acci
       ...
       n_particle.position = new_posj
       n_particle.velocity = new_velj
       n_particle.acceleration = new_accj
