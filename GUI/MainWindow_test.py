...
"background-color: white;")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(60, 580, 421, 102))
        ...
        self.widget.setGeometry(QtCore.QRect(61, 41, 521, 85))
        self.widget.setObjectName("widget")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.widget)
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.import_text = QtWidgets.QLabel(parent=self.widget)
        self.import_text.setObjectName("import_text")
        self.gridLayout_2.addWidget(self.import_text, 1, 0, 1, 1)
        self.import_path = QtWidgets.QLineEdit(parent=self.widget)
        ...
        self.import_change_path = QtWidgets.QPushButton(parent=self.widget)
        self.import_change_path.setObjectName("import_change_path")
        self.gridLayout_2.addWidget(self.import_change_path, 2, 0, 1, 1)
        self.import_comboBox = QtWidgets.QComboBox(parent=self.widget)
